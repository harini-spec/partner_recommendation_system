...
def find_similar_learner(info, columns, primary_column,sec_col):
    ...
    similar_5_list = find_top_similar_entitties(10, df, distance_frame, primary_column, sec_col)
